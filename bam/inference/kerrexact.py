...
def ray_trace_case_1(r1, r2, r3, r4, up, um, axisymmetric = True):
    """
...
def ray_trace_case_2(r1, r2, r3, r4, up, um, axisymmetric = True):
    """
    Case 2: r1, r2, r3, r4 are real.
    """
    pass

def ray_trace_case_3(r1, r2, r3, r4, up, um, axisymmetric = True):
    """
    Case 3: r1 and r2 are real, r3 and r4 are complex.
    """
    pass

def ray_trace_case_4(r1, r2, r3, r4, up, um, axisymmetric = True):
    """
    Case 4: All are complex.
    """
    pass
...
def ray_trace(mudists, fov_uas, MoDuas, varphi, inc, a, nmax, adap_fac = 1, axisymmetric=True):
    ...
    rays1 = ray_trace_case_1(rr1[case1],rr2[case1],rr3[case1],rr4[case1],up[case1],um[case1],axisymmetric=axisymmetric)
    rays2 = ray_trace_case_2(rr1[case2],rr2[case2],rr3[case2],rr4[case2],up[case2],um[case2],axisymmetric=axisymmetric)
    rays3 = ray_trace_case_3(rr1[case3],rr2[case3],rr3[case3],rr4[case3],up[case3],um[case3],axisymmetric=axisymmetric)
    rays4 = ray_trace_case_4(rr1[case4],rr2[case4],rr3[case4],rr4[case4],up[case4],um[case4],axisymmetric=axisymmetric)
